...
import Animated, { Extrapolation, interpolate, useAnimatedProps, useAnimatedStyle, useDerivedValue, useSharedValue, withSpring } from 'react-native-reanimated';
...
const DrawerLayout = function DrawerLayout(props) {
  ...
  const emitStateChanged = useCallback((newState, drawerWillShow) => {
    ...
    onDrawerStateChanged && scheduleOnRN(onDrawerStateChanged, newState, drawerWillShow);
  }, [onDrawerStateChanged]);
  ...
  }, [animationSpeedProp, openValue, emitStateChanged, isDrawerOpen, hideStatusBar, onDrawerClose, onDrawerOpen, drawerWidth, statusBarAnimation]);
