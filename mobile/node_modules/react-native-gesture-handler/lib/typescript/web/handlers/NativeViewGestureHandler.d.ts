...
export default class NativeViewGestureHandler extends GestureHandler {
    ...
    private startY;
    private minDistSq;
    private readonly scrollActivationThresholdSq;
    private isScrollDriven;
    private scrollDetected;
    private lastActiveHandlerData;
    private hasLongPressHandler;
    private longPressDuration;
    private longPressDetected;
    private lastEventWasInside;
